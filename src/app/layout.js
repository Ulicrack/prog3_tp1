  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        ...
        <nav className="relative bg-zinc-800 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    ...
                    <Link href="/stats" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">
                      Stats
                    </Link>                    
                  </div>
                </div>
        ...
        <footer className="bg-zinc-800 text-gray-400 text-sm mt-auto">
          <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            
            <div>
              <p className="text-white font-medium">App realizada por Ulises Cabrera, estudiante de 3er año de la carrera de Desarrorllo de Software, iTec Río IV</p>
              <p>App de Notas con Next.js</p>
            </div>

            <div className="flex gap-4">
              <Link href="/" className="hover:text-white">Inicio</Link>
              <Link href="/notes" className="hover:text-white">Notas</Link>
